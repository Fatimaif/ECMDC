    ...
    <section className="w-full" style={{ backgroundColor: '#F1EEEA' }}>
      <div className="w-full px-4 md:px-10 pt-20 pb-16 flex flex-col items-center">
        <h1 className="text-5xl md:text-6xl font-light text-[#1a1a1a] mb-10 text-center">
          Industrial Goods Excellence
        </h1>

        <p className="max-w-3xl text-lg md:text-xl leading-relaxed text-[#1a1a1a] text-center">
          ECMDC helps industrial companies optimize operations, embrace Industry 4.0 technologies, and drive sustainable growth in competitive markets.
        </p>
      </div>
      ...
      <div className="w-full py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-10">
          <p className="text-sm md:text-base leading-relaxed text-[#1a1a1a] text-center max-w-4xl mx-auto">
            We support manufacturers and industrial firms in modernizing production, improving supply chains, and implementing smart factory solutions. Our expertise includes operational excellence, digital transformation, and strategic growth initiatives.
          </p>
        </div>
      </div>
    </section>
