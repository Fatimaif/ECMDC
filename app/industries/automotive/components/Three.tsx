...
const Three = () => {
  ...
  const toggleSection = (index: number) => {
    ...
    const sections = [
    {
      ...
      content: "Transition to electric vehicle platforms with comprehensive product and manufacturing strategies. This includes developing EV architectures, building battery capabilities, and establishing charging infrastructure that positions your organization for the electric future."
    },
    {
      title: "Implement Smart Manufacturing",
      content: "Modernize production with digital technologies and automation that improve efficiency and quality. This involves deploying connected systems, robotics, and data analytics that optimize operations and enable flexible manufacturing."
    }
  ];
