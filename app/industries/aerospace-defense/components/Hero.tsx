    ...
    <section className="w-full" style={{ backgroundColor: '#F1EEEA' }}>
      <div className="w-full px-4 md:px-10 pt-20 pb-16 flex flex-col items-center">
        ...
        <p className="max-w-3xl text-lg md:text-xl leading-relaxed text-[#1a1a1a] text-center">
          ECMDC partners with aerospace and defense organizations to drive innovation, optimize operations, and navigate complex challenges in the global security landscape.
        </p>
      </div>
      ...
      <div className="w-full py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-10">
          <p className="text-sm md:text-base leading-relaxed text-[#1a1a1a] text-center max-w-4xl mx-auto">
            We help organizations modernize defense systems, improve supply chain resilience, and integrate cutting-edge technologies. Our expertise spans program management, digital transformation, and strategic planning to ensure mission success and competitive advantage.
          </p>
        </div>
      </div>
    </section>
