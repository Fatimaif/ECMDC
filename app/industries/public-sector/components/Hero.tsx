    ...
    <section className="w-full" style={{ backgroundColor: '#F1EEEA' }}>
      <div className="w-full px-4 md:px-10 pt-20 pb-16 flex flex-col items-center">
        ...
        <p className="max-w-3xl text-lg md:text-xl leading-relaxed text-[#1a1a1a] text-center">
          ECMDC helps government organizations improve service delivery, optimize operations, and implement digital solutions for citizen benefit.
        </p>
      </div>
      ...
      <div className="w-full py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-10">
          <p className="text-sm md:text-base leading-relaxed text-[#1a1a1a] text-center max-w-4xl mx-auto">
            We partner with federal, state, and local agencies to modernize operations, enhance citizen services, and achieve mission objectives. Our expertise includes digital government, operational efficiency, policy implementation, and public service innovation.
          </p>
        </div>
      </div>
    </section>
