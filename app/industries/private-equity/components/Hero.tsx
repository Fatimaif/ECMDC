    ...
    <section className="w-full" style={{ backgroundColor: '#F1EEEA' }}>
      <div className="w-full px-4 md:px-10 pt-20 pb-16 flex flex-col items-center">
        ...
        <p className="max-w-3xl text-lg md:text-xl leading-relaxed text-[#1a1a1a] text-center">
          ECMDC partners with private equity firms and portfolio companies to drive value creation, operational improvement, and successful exits.
        </p>
      </div>
      ...
      <div className="w-full py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-10">
          <p className="text-sm md:text-base leading-relaxed text-[#1a1a1a] text-center max-w-4xl mx-auto">
            We support PE firms in due diligence, post-acquisition integration, and portfolio company transformation. Our expertise includes value creation planning, operational excellence, growth strategy, and exit preparation for maximum returns.
          </p>
        </div>
      </div>
    </section>
