    ...
    <section className="w-full" style={{ backgroundColor: '#F1EEEA' }}>
      <div className="w-full px-4 md:px-10 pt-20 pb-16 flex flex-col items-center">
        <h1 className="text-5xl md:text-6xl font-light text-[#1a1a1a] mb-10 text-center">
          Financial Institutions Excellence
        </h1>

        <p className="max-w-3xl text-lg md:text-xl leading-relaxed text-[#1a1a1a] text-center">
          ECMDC partners with banks, investment firms, and financial services organizations to drive digital transformation and navigate regulatory complexity.
        </p>
      </div>
      ...
      <div className="w-full py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-10">
          <p className="text-sm md:text-base leading-relaxed text-[#1a1a1a] text-center max-w-4xl mx-auto">
            We help financial institutions modernize operations, improve customer engagement, and build resilient technology platforms. Our expertise spans digital banking, risk management, fintech innovation, and regulatory compliance across all banking sectors.
          </p>
        </div>
      </div>
    </section>
