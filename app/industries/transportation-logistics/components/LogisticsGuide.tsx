        ...
        <div className="absolute inset-0 px-8 md:px-10 py-8 flex items-center gap-12">
          <div className="flex-1">
            <h2 className="text-4xl md:text-5xl font-light text-white">
              The Future of Supply Chain: Digital Transformation in Logistics
            </h2>
          </div>
          <div className="flex-1">
            <p className="text-lg md:text-xl text-white leading-relaxed">
              Discover how leading logistics companies are leveraging technology, automation, and data analytics to build resilient, sustainable, and customer-centric operations.
            </p>
          </div>
