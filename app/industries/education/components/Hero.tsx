    ...
    <section className="w-full" style={{ backgroundColor: '#F1EEEA' }}>
      <div className="w-full px-4 md:px-10 pt-20 pb-16 flex flex-col items-center">
        ...
        <p className="max-w-3xl text-lg md:text-xl leading-relaxed text-[#1a1a1a] text-center">
          ECMDC partners with educational institutions to improve learning outcomes, optimize operations, and prepare students for future success through innovation.
        </p>
      </div>
      ...
      <div className="w-full py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-10">
          <p className="text-sm md:text-base leading-relaxed text-[#1a1a1a] text-center max-w-4xl mx-auto">
            From K-12 schools to universities and training programs, we help organizations embrace digital learning, improve student outcomes, and build sustainable financial models. Our solutions include curriculum design, digital platforms, and operational excellence.
          </p>
        </div>
      </div>
    </section>
