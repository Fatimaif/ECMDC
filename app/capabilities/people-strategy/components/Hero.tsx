    ...
    <section className="w-full" style={{ backgroundColor: '#F1EEEA' }}>
      <div className="w-full px-4 md:px-10 pt-20 pb-16 flex flex-col items-center">
        ...
        <p className="max-w-3xl text-lg md:text-xl leading-relaxed text-[#1a1a1a] text-center">
          ECMDC delivers people and talent solutions that build workforce capabilities, develop leaders, and create engaging employee experiences.
        </p>
      </div>
      ...
      <div className="w-full py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-10">
          <p className="text-sm md:text-base leading-relaxed text-[#1a1a1a] text-center max-w-4xl mx-auto">
            We help organizations develop talent strategies, build leadership capabilities, and improve employee experience. Our expertise includes talent management, leadership development, HR transformation, and workforce analytics.
          </p>
        </div>
      </div>
    </section>
