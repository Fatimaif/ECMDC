...
const Three = () => {
  ...
  const toggleSection = (index: number) => {
    ...
    const sections = [
    {
      ...
      content: "Create roadmap for AI adoption aligned with business priorities. This includes identifying use cases, assessing readiness, and developing plans that guide AI implementation and ensure business value."
    },
    {
      title: "Deploy AI at Scale",
      content: "Implement AI solutions across the enterprise with proper governance. This involves building AI infrastructure, establishing ethical guidelines, and creating operating model that enables sustainable AI adoption."
    }
  ];
  ...
  return (
    <section className="w-full bg-white px-4 md:px-10 pt-10 pb-20 flex flex-col items-center">
      <h2 className="text-4xl md:text-5xl font-light text-black max-w-4xl leading-tight text-center">
        Two Strategic Plays for AI Leadership
      </h2>
