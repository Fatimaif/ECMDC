    ...
    <section className="w-full" style={{ backgroundColor: '#F1EEEA' }}>
      <div className="w-full px-4 md:px-10 pt-20 pb-16 flex flex-col items-center">
        ...
        <p className="max-w-3xl text-lg md:text-xl leading-relaxed text-[#1a1a1a] text-center">
          ECMDC provides comprehensive cybersecurity solutions to protect organizations from evolving threats and ensure compliance with regulatory requirements.
        </p>
      </div>
      <div className="w-full px-4 md:px-10 pb-0 flex justify-center">
        <div className="w-full overflow-hidden rounded-3xl">
          <div className="h-[420px] md:h-[500px] w-full">
            <img
              src="https://images.pexels.com/photos/60505/computer-keyboard-electronics-technology-60505.jpeg"
              alt="Cybersecurity"
      ...
      <div className="w-full py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-10">
          <p className="text-sm md:text-base leading-relaxed text-[#1a1a1a] text-center max-w-4xl mx-auto">
            We help organizations strengthen security posture, implement threat detection, and build resilient defenses. Our expertise spans security assessment, incident response, compliance management, and identity protection.
          </p>
        </div>
      </div>
    </section>
